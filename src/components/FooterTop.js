    ...
    return(
        <footer>
            <Container className={"top-footer-container"}>
                <Row>
                    <Col xl={2} className={"products-container"}>
                        <RedirectLink
                    ...
                    <Col xl={2} className={"solutions-container"}>
                        <RedirectLink
                    ...
                    <Col xl={2} className={"initiatives-container"}>
                        <RedirectLink
                    ...
                    <Col xl={2} className={"community-container"}>
                        <RedirectLink
                    ...
                    <Col xl={2} className={"resources-container"}>
                        <RedirectLink
                    ...
                    <Col xl={2} className={"company-container"}>
                        <RedirectLink
